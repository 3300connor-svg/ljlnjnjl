...
DEFAULT_IMAGE_PROMPT = (
    ...
    "Replace the subject's face and hair with the person from the reference image: transplant "
    "her exact facial features, skin tone, and expression. For hair: match the reference hair "
    "color and style but preserve the original hair length and overall shape from the scene. "
    "Hair highlights must be natural sun-kissed balayage blended evenly throughout — NOT a "
    "single streak or panel on one side. Photorealistic, no artifacts, no halo, clean hairline "
    "and scalp. Authentic iPhone photo quality. Vertical 9:16 framing."
)
